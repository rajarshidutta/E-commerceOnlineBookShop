...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  <a class="navbar-brand" href="#"><i class="fa-sharp fa-solid fa-house-chimney"></i></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
        ...
        <a href="helpline.jsp" class="btn btn-light my-2 my-sm-0 ml-1" type="submit"><i class="fa-sharp fa-solid fa-phone-volume"></i> Contact Us</a>
    </form>
  </div>
</nav>
